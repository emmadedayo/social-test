...
Post_Model_1.PostSchema.plugin(mongoose_paginate_v2_1.default);
const PostModel = mongoose_1.default.models.Follow || mongoose_1.default.model('Follow', exports.FollowSchema);
